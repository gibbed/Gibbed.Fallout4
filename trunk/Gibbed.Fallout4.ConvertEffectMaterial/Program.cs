...
namespace Gibbed.Fallout4.ConvertEffectMaterial
{
    internal class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Usage: {0} [OPTIONS]+ input_bgem [output_json]", GetExecutableName());
                Console.WriteLine("       {0} [OPTIONS]+ input_json [output_bgem]", GetExecutableName());
                Console.WriteLine();
            ...
            using (var input = File.OpenRead(inputPath))
            {
                ...
                if (b != '{')
                {
                    ...
                    var material = new EffectMaterialFile();
                ...
                else
                {
                    var outputPath = extras.Count > 1
                                         ? Path.GetFullPath(extras[1])
                                         : Path.ChangeExtension(inputPath, ".bgem");
